...
class HBaseTpcMiniTestSuite extends TestBase {
  ...
  test("Query 7.1") {
    ...
    assert(rows(0)(1) == 6)
    assert(rows(0)(2) == null) // should not be null?
  }
